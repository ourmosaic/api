...
export class MembersController {
  ...
  @UseInterceptors(SystemInterceptor)
  @ApiOkResponse({
    description: 'Front session started successfully',
  ...
  @UseInterceptors(SystemInterceptor)
  @ApiOkResponse({
    description: 'Front session ended successfully',
    type: FrontSessionEntity,
  })
  @ApiForbiddenResponse({ description: 'Forbidden.' })
  ...
  @UseInterceptors(SystemInterceptor)
  @ApiOkResponse({
    description: 'Front sessions retrieved successfully',
    type: [FrontSessionEntity],
  })
  @ApiForbiddenResponse({ description: 'Forbidden.' })
  ...
  @UseInterceptors(SystemInterceptor)
  @ApiOkResponse({
    description: 'Groups removed from member successfully',
    type: MemberEntity,
  })
  @ApiForbiddenResponse({ description: 'Forbidden.' })
